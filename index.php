...
<body>
    ...
    <div class="kode_wrapper">
        ...
        <!-- register Modal -->
    <div class="modal fade" id="registr" tabindex="-1" role="dialog">
				...
				<div class="item">
					<figure>
						...
						<figcaption>
							...
							<h2 class="slider-txt">We bring new online courses</h2>
							<p>The School With International Standards</p>
							<a href="#" class="btn-1">read more</a>
						</figcaption>
					</figure>
		...
		<div class="kf_content_wrap">
					...
					<div class="row">
						...
						<div class="col-md-8">
						    <div class="abt_univ_wrap">
								<!-- HEADING 1 START-->
								<div class="kf_edu2_heading1" style="padding-top:60px">
									<h5>About Apex International School</h5>
									<h3>The School With International Standard</h3>
								</div>
								<!-- HEADING 1 END-->
								...
								<div class="abt_univ_des">
									...
									<a href="aboutus.php" class="btn-3">Know More</a>
						...
						<div class="col-md-4">
							...
							<div class="kf_edu2_search_wrap">
								...
								<form>
									...
									<div class="edu2_serc_des">
										<select>
                                            <option value="1">Areas Of Intrest</option>
								...
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<div class="edu2_event_des">
											<h4>Jun</h4>
											<p>School Day Celebration 2017</p>
							...
							<div class="edu2_new_des">
								<div class="row">
									...
									<div class="col-md-6 col-sm-6">
										<div class="edu2_event_des ">
											<h4>May</h4>
											<p>Talent Day Celebration 2017</p>
											<ul class="post-option">
 												<li>By<a href="#">Admin</a></li>
 												<li>03/12/2015</li>
 												<li><a href="#">21 Comments</a></li>
							...
							<div class="edu2_new_des">
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<div class="edu2_event_des">
											<h4>Dec</h4>
											<p>Fine Arts Day Celebration 2017</p>
											<ul class="post-option">
 												<li>By<a href="#">Admin</a></li>
 												<li>03/12/2015</li>
 												<li><a href="#">21 Comments</a></li>
			...
			<section class="kode-gallery-section">
                ...
                <div class="col-md-12">
                    <div class="kf_edu2_heading2">
                        <h3>Our Gallery</h3>
						<p>Student gallery of the year</p>
                    </div>
                </div>
                <!-- HEADING 2 END-->
                ...
                <div class="edu2_gallery_wrap gallery">
                    ...
                    <div class="gallery3">
                        ...
                        <div class="filterable-item all 3 5 7 9 col-md-3 col-sm-4 col-xs-12 no_padding">
                            <div class="edu2_gallery_des">
                                <figure>
                                    <img alt="" src="extra-images/home-gallery8.jpg">
                                    <figcaption>
							...
							<div id="owl-demo-8" class="owl-carousel owl-theme">
								<div class="item">
									...
									<div class="edu2_faculty_des">
										...
										<div class="edu2_faculty_des2">
											<h6><a href="#">Amrutha Santhosh</a></h6>
								...
								<div class="item">
									...
									<div class="edu2_faculty_des">
										...
										<div class="edu2_faculty_des2">
											<h6><a href="#">Abdul Razaq M.M </a></h6>
								...
								<div class="item">
									...
									<div class="edu2_faculty_des">
										...
										<div class="edu2_faculty_des2">
											<h6><a href="#">Abdusubhan</a></h6>
											<strong>Clerck</strong>
