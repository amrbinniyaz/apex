					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="widget wiget-instagram">
								<h5>EVENTS</h5>
								<ul>
									<li><a href="#"><img src="extra-images/instagram-1.png" alt=""/></a></li>
						...
						<div class="col-md-3">
							<div class="widget widget-contact">
								<h5>Contact</h5>
								<ul>
									<li>APEX INTERNATIONAL SCHOOL,Odumbra, Olavanna.P.O, Calicut-673 025,Kerala, India.
</li>
									<li>Phone: <a href="#">0495 2432800,0495 2432811</a></li>
									
									<li>Email : <a href="#">info@apexinternationalschool.org</a></li>
								</ul>
							</div>
						</div>
						<!--EDU2 FOOTER CONTANT DES END-->
				...
				<div class="row">
					<div class="col-md-3">
						<div class="edu2_ft_logo_wrap">
							<a href="#"><img src="extra-images/logo%20white-01.png" alt=""/></a>
						</div>
					</div>

					<div class="col-md-6">
						<div class="copyright_des">
							<span>&copy; All Rights reserved. Powered By <a href="http://amrbinniyaz.com/">AMR</a></span>
						</div>
					</div>
